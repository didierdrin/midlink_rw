...
<!--  Author Name: Mayuri K. 
 ...
 if ($currentUserId > 0) {
 	$userSql = "SELECT * FROM users WHERE user_id = {$currentUserId}";
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <fieldset>
                        ...
                        <label for="username" class="col-sm-8 control-label">Username</label>
                        <div class="col-sm-10">
                ...
                <form action="php_action/changePassword.php" method="post" class="form-horizontal" id="changePasswordForm">
                    <fieldset>
                        ...
                        <div class="form-group">
                        <label for="password" class="col-sm-8 control-label">Current Password</label>
                        <div class="col-sm-10">
                      ...
                      <div class="form-group">
                        <label for="npassword" class="col-sm-8 control-label">New password</label>
                        <div class="col-sm-10">
                      ...
                      <div class="form-group">
                        <label for="cpassword" class="col-sm-8 control-label">Confirm Password</label>
                        <div class="col-sm-10">
