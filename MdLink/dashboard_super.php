        ...
        <div class="dashboard-header">
            <div class="header-content">
                <div class="header-logo">
                    <!-- Custom Logo - Your MdLink Rwanda Logo -->
                    <img src="assets/uploadImage/Logo/logo.png" alt="MdLink Rwanda Logo" class="custom-logo" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                ...
                <div class="header-text">
                    ...
                    <p class="dashboard-subtitle">
                        Super Admin Dashboard - Complete Pharmacy Management System
                    </p>
                </div>
            </div>
      </div>
