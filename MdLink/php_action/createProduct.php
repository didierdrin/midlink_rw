...
if ($upload) {
 // @unlink("uploadImage/Profile/".$_POST['old_image']);
	...
	$orderDate=date('Y-m-d');
				$sql = "INSERT INTO product (product_name, product_image, brand_id, category_id, quantity, rate,mrp,bno,expdate,added_date,active, status) 
