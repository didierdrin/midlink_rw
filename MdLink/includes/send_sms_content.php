...
// Include SMS configuration to get approved sender IDs
require_once __DIR__ . '/sms_config.php';
$availableSenderIds = getAvailableSenderIds();
            ...
            <div class="row">
                <div class="col-lg-8">
                    <!-- Message Composition -->
                         ...
                         <select class="form-select" id="senderId" name="senderId" required>
                             <?php foreach ($availableSenderIds as $senderId): ?>
                                 <option value="<?php echo htmlspecialchars($senderId); ?>" 
                                         <?php echo ($senderId === $defaultSenderId) ? 'selected' : ''; ?>>
                                     <?php echo htmlspecialchars($senderId); ?>
                                 </option>
                             <?php endforeach; ?>
                         </select>
                         <small class="form-text text-muted">Select from pre-approved sender IDs</small>
                     </div>
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div class="message-preview" id="messagePreview">
                                                                 <strong>From:</strong> <span id="previewSender"><?php echo htmlspecialchars($defaultSenderId); ?></span><br>
...
<script>
    $(document).ready(function() {
        ...
        $('#messageContent').on('input', function() {
         ...
         $('#senderId, #recipientPhone').on('change input', updateMessagePreview);
    });
    ...
    function updateSmsHistoryTable(data) {
     ...
     function updateMessagePreview() {
         const sender = $('#senderId').val() || '<?php echo $defaultSenderId; ?>';
